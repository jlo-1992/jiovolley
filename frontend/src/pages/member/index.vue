<template>
  <div class="bg-light pb-15">
    <v-row>
      <v-col cols="12" md="10" class="mt-10 mx-auto">
        <div>
          <h1 class="name text-h4">嗨， {{ userInfo.name }}!</h1>
          <p class="text-grey-darken-1 text-h6" style="font-family: 'Huninn', sans-serif">
            來看看你最近的活動紀錄吧~
          </p>
        </div>
      </v-col>
    ...
    <v-row justify="center">
      <v-col cols="12" md="5">
        <v-card class="pa-4 card mb-5">
          <v-card-title class="card-title">球員檔案</v-card-title>
          <v-row>
            <v-col cols="12">
        ...
        <div class="mb-5">
          <v-card class="pa-6 card">
            <v-card-title class="d-flex align-center justify-space-between">
              <div class="card-title" style="">我的出席統計</div>
              <v-select
